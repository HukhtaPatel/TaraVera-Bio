    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white dark:bg-gray-900">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/50 dark:to-purple-950/50 border border-blue-100 dark:border-blue-800 mb-8 animate-fade-in">
          ...
          <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Precision Neurobiology Platform</span>
        </div>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="text-center p-6 rounded-xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 transition-all duration-300">
            <div className="text-4xl font-bold text-blue-600 dark:text-blue-400 mb-2">X-Linked</div>
            <div className="text-sm text-gray-600 dark:text-gray-400">USP11 genetic vulnerability</div>
          </div>
          <div className="text-center p-6 rounded-xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200 dark:border-gray-700 hover:border-purple-300 dark:hover:border-purple-600 transition-all duration-300">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">To lead molecule generation</div>
          </div>
          <div className="text-center p-6 rounded-xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200 dark:border-gray-700 hover:border-pink-300 dark:hover:border-pink-600 transition-all duration-300">
            <div className="text-4xl font-bold text-pink-600 dark:text-pink-400 mb-2">25+ Years</div>
            <div className="text-sm text-gray-600 dark:text-gray-400">Combined pharma expertise</div>
          </div>
        </div>
      </div>
    </section>
